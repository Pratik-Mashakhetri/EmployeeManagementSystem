                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <Link to="/admindashboard" className="nav-link active">Home</Link>
                            </li>
                            <li class="nav-item">
                                <Link to="/addemp" className="nav-link">AddEmployee</Link>
                            </li>
                              <li class="nav-item">
                                <Link to="/viewemp" className="nav-link">ViewEmployee</Link>
                            </li>
                             <li class="nav-item">
                                <Link to="/manageleaves" className="nav-link">Check Leaves</Link>
                            </li>
                              <li class="nav-item">
